...
describe Redcaser::ExecutionsuitesController, type: :controller do
  ...
  context 'logged in as admin' do
    ...
    let(:suite) do
      create :execution_suite, project_id: @project.id
    end
    ...
    context 'without initial settigns' do
      ...
      it 'GET #show responds with forbidden' do
        get :show, project_id: @project.id, id: suite.id
    ...
    context 'with initial settigns' do
      ...
      it 'GET #index responds with success' do
        ...
        expect(response).to render_template('redcaser/_execution_list')
      end
